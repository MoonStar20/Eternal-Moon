...
namespace cLauncher
{
    public partial class MainWindow : Form
    {
        ...
        {
            string webStringResponse = getWebStringResponse(Configuration.GetLauncherAuthUrl(), "POST", "username=" + _inputboxUsername.Text + "&password=" + Crypt.StringToMD5(_inputboxPassword.Text));
